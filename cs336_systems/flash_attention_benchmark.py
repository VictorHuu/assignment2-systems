...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--csv-path", type=Path, default=Path("reports/flash_attention_benchmark_results.csv"))
    parser.add_argument("--markdown-path", type=Path, default=Path("reports/flash_attention_benchmark_results.md"))
